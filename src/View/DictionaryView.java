...
public class DictionaryView extends JFrame {
    ...
    private void initComponents() {
        ...
        searchIcon.setIcon(new ImageIcon("lib\\icon dictionary\\search.png")); // NOI18N
        ...
        speakButton.setIcon(new ImageIcon("lib\\icon dictionary\\speaker1.png"));
        ...
        undoButton.setIcon(new ImageIcon("lib\\icon dictionary\\undo1.png"));
    ...
    public void setSpeaker(String voice) {
