...
public class Options extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        logo.setIcon(new javax.swing.ImageIcon("lib\\icon dictionary\\UETLogo.png")); // NOI18N
                ...
                try {
                    ...
                    if (findWord().length() == 0) {
                        ...
                        if (word.getDefine().length() > 0){
                            ...
                            JOptionPane.showMessageDialog(this, "Please enter your define!", "ERROR",
                                    JOptionPane.ERROR_MESSAGE);
                        }
